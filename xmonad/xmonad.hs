...
myWorkspaces =
  [
    "7:dev3",  "8:scope", "9:debug",
    "4:diffs",  "5:dev1", "6:dev2",
    "1:Term",  "2:firefox", "3:apps",
    "0:Scratch",    "Extr1", "Extr2"
  ]
...
myKeyBindings =
  [
    ...
    , ((myModMask, xK_m), spawn "amixer -q set Master toggle")
    , ((myModMask, xK_comma), spawn "amixer -q set Master 10%-")
    , ((myModMask, xK_n), spawn "amixer -q set Master 10%+")
...
myManagementHooks = [
  ...
  , (className =? "Komodo IDE") --> doF (W.shift "5:dev1")
  , (className =? "Komodo IDE" <&&> resource =? "Komodo_find2") --> doFloat
  , (className =? "Komodo IDE" <&&> resource =? "Komodo_gotofile") --> doFloat
  , (className =? "Komodo IDE" <&&> resource =? "Toplevel") --> doFloat
  , (className =? "Empathy") --> doF (W.shift "7:dev3")
  , (className =? "Firefox") --> doF (W.shift "2:firefox")
  , (className =? "bcompare") --> doF (W.shift "4:diffs")
  , (className =? "Bcompare") --> doF (W.shift "4:diffs")
  ]
